...
<div class="container">
    <form method="post" action="/facility?action=edit">
        <div class="mb-3">
            ...
            <input name="id" value="${facility.id}" type="number" class="form-control" id="exampleInputEmail1">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Name</label>
            <input name="name" value="${facility.name}" type="text" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Area</label>
            <input name="area" value="${facility.area}" type="text" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Cost</label>
            <input name="cost" value="${facility.cost}" type="number" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Max people</label>
            <input name="maxpeople" value="${facility.maxPeople}" type="number" class="form-control">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="standardroom" value="${facility.standardRoom}" type="text" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Convenient</label>
            <input name="convenient" value="${facility.convenience}" type="text" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Pool Area</label>
            <input name="poolarea" value="${facility.poolArea}" type="number" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Floor</label>
            <input name="floor" value="${facility.floor}" type="number" class="form-control">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Facility Free</label>
            <input name="facilityfree" value="${facility.facilityFree}" type="text" class="form-control">
        </div>
